...
pub(crate) const TABLE: &[(&str, &str)] = &[
    ...
    ("Finished", "Terminada"),
    (
        "Follow what it is saying now",
        "Seguir lo que está diciendo ahora",
    ),
    ("Following", "Siguiendo"),
    ("For", "Para"),
    ...
    ("No values — restoring this clears the environment.", "Sin valores — restaurar esto deja el entorno vacío."),
