...
fn migrations() -> Vec<Migration> {
    vec![
        ...
        Migration::new("0025_grant", include_str!("../migrations/0025_grant.sql")),
        Migration::new("0026_allows", include_str!("../migrations/0026_allows.sql")),
        Migration::new(
        ...
        Migration::new(
            "0034_replica_memory",
            include_str!("../migrations/0034_replica_memory.sql"),
        ),
        Migration::new(
            "0035_replica_disk",
